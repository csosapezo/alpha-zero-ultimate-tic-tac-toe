...
rlp = RLUTTTPlayer(NNUltimateLearning(filename='./ultimate_ttt_rl/ultimate_player_nn1.h5'))

# nnet players
n1 = NNet(g)
n1.load_checkpoint('./pretrained_models/ultimate_tictactoe/keras/',
                   'ultimate_tictactoe_100_eps_10_epoch_checkpoint_5.h5')
